            ...
            <div class="flex">
                <div class="w-6/12 p-6 bg-white rounded-sm mr-3">
                  ...
                  <div class="flex w-full mb-8">
                      ...
                      <div class="w-1/4 text-center" v-tippy="{ content: 'Pageviews' }">
                          <h2 class="uppercase">Pages</h2>
                          <h1 class="text-4xl ml-auto font-bold">
                              {{ nFormatter(stats.page_view.count, 1) }}
                          </h1>
                      </div>
                      <div class="w-1/4 text-center" v-tippy="{ content: 'Leaderboard Entries' }">
