    ...
    <app-layout title="Dashboard">
        ...
        <div class="flex mt-6">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <div class="flex w-full mt-4 justify-center">
                        <div class="w-1/3 text-center" v-tippy="{ content: `<div class='p-2 w-40 text-center'>Total number of games played till the end<div>`, followCursor: false }">
                            <h2 class="uppercase text-xs">Quiz Played</h2>
            ...
            <div v-if="grid.share" class="w-1/3 bg-white rounded-sm mr-3">
                ...
                <div class="flex w-full mt-4 justify-center">
                    <div class="w-1/3 text-center" v-tippy="{ content: `<div class='p-2 w-40 text-center'>Total number of downloads<div>`, followCursor: false }">
                        <h2 class="uppercase text-xs">Total Downloads</h2>
                        <h1 class="text-2xl ml-auto font-bold">
