        ...
        <div class="flex mt-6">
            <div class="w-1/3 bg-white rounded-sm mr-3">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <div class="flex w-full justify-center mt-4">
                        ...
                        <pie-chart class="p-16" :library="{ animation: { duration: 3000 }}" :colors="['#00bcf2','#8378de']" :legend="false" v-if="filters.profile == 'Gender'" :data="charts.gender"></pie-chart>
                        <pie-chart class="p-16" :library="{ animation: { duration: 3000 }}" :colors="['#00bcf2','#8378de','#005b70','#c239b3','#881798','#0078d4','#8764b8']" :legend="false" v-if="filters.profile == 'Age'" :data="charts.age"></pie-chart>
            ...
            <div class="w-1/3 bg-white rounded-sm ml-3">
                ...
                <h2 class="flex w-full p-4 border-b mb-4">
                    ...
                    <div class="filters-dropdown">
                        ...
                        <aside>
                            <ul>
                                <li :class="{ 'font-bold' : filters.registrations == 'Origin' }" @click="filters.registrations='Origin'">Origin</li>
                    ...
                    <section class="flex-table p-6 mt-8">
                        ...
                        <div
                            ...
                            class="flex-table-row">
                                ...
                                <div class="col text-right">{{ top.views }}</div>
                                <div :style="{ width: calcPerc(top.views, stats.participants.count) }" class="duration-300 left-0 bottom-0 border-b-2 absolute border-ms-orange-10"></div>
                        </div>
                    </section>
                </div>

                <div v-if="filters.registrations == 'Score'" class="p-6">
                    <column-chart height="240px" :library="{ animation: { duration: 3000 }}" :colors="['#c239b3']" :data="charts.leaderboard"></column-chart>
                </div>
         ...
         <div class="flex mt-6">
            <div class="w-1/3 bg-white rounded-sm mr-3">
                ...
                <div class="flex w-full mt-4 justify-center">
                    <div class="w-1/3 text-center" v-tippy="{ content: `<div class='p-2 w-40 text-center'>Total number of shared URLs on social media<div>`, followCursor: false }">
