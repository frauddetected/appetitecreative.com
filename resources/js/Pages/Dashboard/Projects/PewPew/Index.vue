                        ...
                        <div class="flex flex-col">
                            <form action="" class="mb-5 w-40">
                                ...
                                <label class="flex items-center my-1">
                                    <input type="checkbox" v-model="exporting.fields" value="email" class="mr-1"> E-mail
                                </label>
                                <label class="flex items-center my-1">
                            ...
                            <button @click="exportDownload" class="border ml-auto border-ms-gray-160 px-4 py-1 hover:bg-ms-gray-40 font-bold">Download</button>
            ...
            <div class="flex">
                <div class="w-6/12 p-6 bg-white rounded-sm mr-3">
                  ...
                  <div class="flex w-full mb-8">
                      ...
                      <div class="w-1/4 text-center" v-tippy="{ content: 'Unique Users' }">
                          <h2 class="uppercase">Users</h2>
                          <h1 class="text-4xl ml-auto font-bold">
                              {{ nFormatter(stats.users.count, 1) }}
                          </h1>
                      </div>
                      <div class="w-1/4 text-center" v-tippy="{ content: 'Participants' }">
                          <h2 class="uppercase">Participants</h2>
                          <h1 class="text-4xl ml-auto font-bold">
                              {{ nFormatter(stats.participants.count, 1) }}
                          </h1>
                      </div>
                      <div class="w-1/4 text-center" v-tippy="{ content: 'Submissions' }">
                          <h2 class="uppercase">Submissions</h2>
                          <h1 class="text-4xl ml-auto font-bold">
                              {{ nFormatter(stats.submissions.count, 1) }}
                          </h1>
                      </div>
                  </div>
                  <div>
            ...
            <div class="w-1/3 bg-white rounded-sm mr-3">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <h2 class="flex w-full border-b p-4 mb-4">
                        Scientists (Avatar) by  
                        <div class="filters-dropdown">
                            <span>{{ filters.scientists }}</span>
                            <aside>
                                <ul>
                                    <li :class="{ 'font-bold' : filters.scientists == 'Views' }" @click="filters.scientists='Views'">Views</li>
                                    <li :class="{ 'font-bold' : filters.scientists == 'Selected' }" @click="filters.scientists='Selected'">Selected</li>
                                </ul>
                            </aside>
                        </div>
                    </h2>
                    ...
                    <div class="flex w-full justify-center mt-4">
                        <div class="w-1/3 text-center" v-tippy="{ content: `<div class='p-2 w-40 text-center'>Total number of selfie filters viewed<div>`, followCursor: false }">
                            <h2 class="uppercase text-xs">Scentists Views</h2>
                            <h1 class="text-2xl ml-auto font-bold">
                                {{ nFormatter(stats.scientist_view.count, 1) }}
                            </h1>
                        </div>
                    </div>
                </div>
                ...
                <section class="flex-table p-6 mt-8">
                    <div class="flex-table-header">
                        <div class="col">Scientists</div>
                        <div class="col text-right">{{ filters.scientists }}</div>
                    </div>
                    <div
                        v-tippy="{ content: `<div class='p-2'>${top.name} <strong class='ml-2'>${top.views} (${calcPerc(top.views, stats[filters.scientists=='Views'?'scientist_view':'scientist_select'].count)})</strong></div>`, followCursor: true }"
                        v-for="top in stats[filters.scientists=='Views'?'scientist_view':'scientist_select'].top"
                        class="flex-table-row">
                            <div class="col font-bold">{{ unCamelCase(top.name) }}</div>
                            <div class="col text-right">{{ top.views }}</div>
                            <div :style="{ width: calcPerc(top.views, stats[filters.scientists=='Views'?'scientist_view':'scientist_select'].count) }" class="duration-300 left-0 bottom-0 border-b-2 absolute border-ms-orange-10"></div>
                    </div>
                </section>
            ...
            <div class="w-1/3 bg-white rounded-sm ml-3">
                ...
                <div v-if="filters.registrations == 'Users'">
                    ...
                    <section class="flex-table p-6 mt-8">
                        ...
                        <div
                            v-for="top in stats.leaderboard.top" 
                            class="flex-table-row">
                                <div class="col font-bold">{{ top.name }}</div>
                                <div class="col text-right">{{ top.score }}</div>
                        </div>
                    </section>
                </div>
