    ...
    <app-layout title="Project Settings">
        ...
        <template #header>
            <h2 class="text-lg text-ms-gray-160 leading-tight">
                Project <span class="text-ms-gray-50">|</span> <span class="text-gradient">i18n</span>
            </h2>
    ...
    export default {
        ...
        data(){
            return{
                ...
                languages: [{"name":"English","code":"EN"},{"name":"Spanish","code":"ES"},{"name":"Portuguese","code":"PT"},{"name":"Arabic","code":"AR"},{"name":"Italian","code":"IT"},{"name":"French","code":"FR"},{"name":"German","code":"DE"}]
            }
        },

        methods: {
            save(){
                this.$inertia.post(route('projects.i18n.store'), this.form, {
                    preserveState: true
                })
            }
        },
        ...
        created(){
            if(this.project.i18n){
                this.form.countries = this.project.i18n && this.project.i18n.countries
                this.form.languages = this.project.i18n && this.project.i18n.languages
            }
        },
