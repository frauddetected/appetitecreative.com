...
window.$link = (_class = /*#__PURE__*/function () {
  function AppetiteLink() {
    _classCallCheck(this, AppetiteLink);
  }
  _createClass(AppetiteLink, null, [{
    key: "instance",
    get: function get() {
    ...
    value: function get(url) {
      ...
      return this.instance.post(url, {
        params: _objectSpread(_objectSpread({}, params), this.API_DEFAULT_PARAMS)
      });
    }
  }, {
    key: "put",
    value: function put(url) {
      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return this.instance.put(url, _objectSpread(_objectSpread({}, params), this.API_DEFAULT_PARAMS));
    }
  }, {
    key: "post",
    value: function post(url) {
      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return this.instance.post(url, _objectSpread(_objectSpread({}, params), this.API_DEFAULT_PARAMS));
    }
      ...
      return {
        playAudio: function playAudio(url) {
          return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var context, source, audioBuffer;
        ...
        getInput: function getInput(parameterName) {
        ...
        getParam: function getParam(parameterName) {
          var result = null,
            tmp = [];
        ...
        removeURLParameter: function removeURLParameter() {
          var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window.location.href;
          var parameter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'ucode';
        ...
        browserLanguage: function browserLanguage() {
          var validLanguages = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
                ...
                case 0:
                  return _context2.abrupt("return", new Promise(function (resolve) {
                    if (!localStorage.getItem('linkApiGeoIp2')) {
                      var geo = AppetiteLink.post('/geo/ip');
                      geo.then(function (r) {
                        localStorage.setItem('linkApiGeoIp2', JSON.stringify(r.data));
                        resolve(r.data);
                      });
                    } else {
                      var data = JSON.parse(localStorage.getItem('linkApiGeoIp2'));
                      resolve(data);
                    }
                  }));
                case 1:
        ...
        geoBrowser: function geoBrowser() {
    ...
    value: function log(name) {
      ...
      return this.post('log/action', _objectSpread({
        name: name,
        values: values
      }, params));
    }
      ...
      var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              token = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : '';
              project_id = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : '';
            ...
            case 8:
              ...
              url = this.$.removeURLParameter();
              history.pushState(state, title, url);

              /* - */
              if (url.includes('count=scan')) {
                urlUpdated = this.$.removeURLParameter(window.location.href, "count");
            ...
            case 16:
              social_media = ['youtube', 'facebook', 'twitter', 'linkedin', 'pinterest', 'tiktok', 'snap', 'vk', 'instagram'];
              sm = social_media.filter(function (str) {
                return document.referrer.includes(str);
              });
    ...
    value: function qrCode() {
      ...
      return new Promise(function (resolve) {
        if (!code) {
          var _this$$$getParam;
          code = (_this$$$getParam = _this.$.getParam('ucode')) !== null && _this$$$getParam !== void 0 ? _this$$$getParam : localStorage.getItem('linkQrCode_Ucode');
        }
        if (localStorage.getItem('linkQrCode_Ucode') && localStorage.getItem('linkQrCode_Ucode') == code) {
          _this.qr = JSON.parse(localStorage.getItem('linkQrCode'));
          resolve();
        } else {
          _this.post('qr/details', _objectSpread({
            ucode: code
    ...
    get: function get() {
      ...
      return {
        details: function details() {
          ...
          var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
          var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          var ucode = (_localStorage$getItem = localStorage.getItem('linkQrCode_Ucode')) !== null && _localStorage$getItem !== void 0 ? _localStorage$getItem : code;
          return self.post('qr/details', _objectSpread({
            ucode: ucode
          }, params));
        },
        burn: function burn() {
          ...
          var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
          var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          var ucode = (_localStorage$getItem2 = localStorage.getItem('linkQrCode_Ucode')) !== null && _localStorage$getItem2 !== void 0 ? _localStorage$getItem2 : code;
          return self.post('qr/burn', _objectSpread({
            ucode: ucode
          }, params));
        }
      };
    ...
    get: function get() {
      ...
      return {
        details: function details(code) {
          var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          return self.post('alphanum/details', _objectSpread({
            code: code
          }, params));
        },
        burn: function burn(code) {
          var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          return self.post('alphanum/burn', _objectSpread({
            code: code
          }, params));
        }
      };
    ...
    get: function get() {
      ...
      return {
        submit: function submit(data) {
          var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          return self.post('selfie/submit', _objectSpread({
            image: data
          }, params));
        }
      };
    ...
    get: function get() {
      var self = this;
      return {
        contact: function contact(platform) {
          var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    get: function get() {
      ...
      return _defineProperty({
        ...
        resetPassword: function resetPassword(email) {
          var mailconfig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          return self.post('auth/resetPassword', _objectSpread({
            email: email
          }, mailconfig));
        },
        ...
        loginOrNew: function loginOrNew() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          self.user.email = params.email;
          var login = self.post('auth/loginOrNew', _objectSpread(_objectSpread({}, params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        ...
        register: function register() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          self.user.email = params.email;
          return self.post('auth/register', _objectSpread(_objectSpread({}, params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        update: function update() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          var update = self.post('auth/update', _objectSpread(_objectSpread({}, self.user), {}, {
            details: _objectSpread({}, params)
          }));
          update.then(function (r) {
            if (r.data.success) {
              localStorage.setItem('authProfile', JSON.stringify(r.data.profile));
            }
          });
        ...
        login: function login() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          self.user.email = params.email;
          var login = self.post('auth/login', _objectSpread(_objectSpread({}, params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
          login.then(function (r) {
            if (r.data.success) {
    ...
    get: function get() {
      ...
      return {
        log: function log() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('quiz/log', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        next: function next() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('quiz/next', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        random: function random() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('quiz/random', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        all: function all() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('quiz/all', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        answered: function answered() {
          ...
          var existent = localStorage.getItem('linkQuizAnswered') ? JSON.parse(localStorage.getItem('linkQuizAnswered')) : [];
          return existent;
        }
      };
    }
    ...
    get: function get() {
      ...
      return {
        view: function view() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('articles/view', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        all: function all() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('articles/all', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        }
      };
    ...
    get: function get() {
      var self = this;
      return {
        handleMsg: function handleMsg(param, event) {
          if (event.data.link) {
            param(event.data.link);
          }
        },
        listen: function listen(param) {
          var handler = this.handleMsg.bind(this, param);
          window.addEventListener('message', handler, false);
          return function () {
            window.removeEventListener('message', handler);
          };
        },
        sendOld: function sendOld(params) {
    ...
    get: function get() {
      ...
      return {
        get: function get() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('leaderboard/get', _objectSpread(_objectSpread(_objectSpread({}, self.user), params), {}, {
            details: _objectSpread(_objectSpread({}, self.details), params.details)
          }));
        },
        submit: function submit() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return self.post('leaderboard/submit', _objectSpread(_objectSpread(_objectSpread({
  ...
  return AppetiteLink;
}(), _defineProperty(_class, "thisUser", localStorage.getItem('linkUser') ? JSON.parse(localStorage.getItem('linkUser')) : {}), _defineProperty(_class, "thisSelection", localStorage.getItem('linkSelection') ? JSON.parse(localStorage.getItem('linkSelection')) : {}), _defineProperty(_class, "thisDetails", localStorage.getItem('linkDetails') ? JSON.parse(localStorage.getItem('linkDetails')) : {}), _class);
})();
